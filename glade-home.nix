{
  ...
  imports = [
    ...
    #./features/fonts.nix
    ./features/nixvim.nix
    ./features/glade/hyprland.nix
    ./features/glade/foot.nix
  ...
  # manage.
  home.username = "lionel";
  home.homeDirectory = "/home/lionel";
  ...
  # or
  #
  #  /etc/profiles/per-user/lionel/etc/profile.d/hm-session-vars.sh
  #
